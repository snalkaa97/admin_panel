...
<header class="main-header home-9">
            ...
            <div class="container">
                <div class="main-box clearfix">
                    <div class="logo-box pull-left">
                        <figure class="logo-box mt-5 ml-4"><a href="index.html"><img src="<?= base_url('uploads/') ?>setting/logo.png" style="width: 100px;" alt=""></a></figure>
                    </div>
        ...
        <div class="sticky-header">
            <div class="container clearfix">
                <figure class="logo-box"><a href="index.html"><img src="<?= base_url('uploads/') ?>setting/logo.png" style="width: 100px;" alt=""></a></figure>
                <div class="menu-area">
    ...
    <!-- main-header end -->
      ...
      <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="index.html"><img src="<?= base_url('uploads/') ?>setting/logo.png" alt="" title=""></a></div>
