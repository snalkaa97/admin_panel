               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success" title="{php_open_tag_echo} cclang('export'); {php_close_tag} {php_open_tag_echo} cclang('{table_name}') {php_close_tag}']); {php_close_tag}" href="{php_open_tag_echo} site_url('administrator/<?= $table_name; ?>/export'); {php_close_tag}"><i class="fa fa-file-excel-o" ></i> {php_open_tag_echo} cclang('export'); {php_close_tag} XLS</a>
                        {php_open_tag} }) {php_close_tag}
                        {php_open_tag} is_allowed('<?= $table_name; ?>_export', function(){{php_close_tag}
                        <a class="btn btn-flat btn-success" title="{php_open_tag_echo} cclang('export'); {php_close_tag} pdf {php_open_tag_echo} cclang('{table_name}') {php_close_tag}']); {php_close_tag}" href="{php_open_tag_echo} site_url('administrator/<?= $table_name; ?>/export_pdf'); {php_close_tag}"><i class="fa fa-file-pdf-o" ></i> {php_open_tag_echo} cclang('export'); {php_close_tag} PDF</a>
                        {php_open_tag} }) {php_close_tag}
                     </div>
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     <thead>
                        <tr class="">
                         ...
                         <?php endif ?>
                           <?php foreach ($this->crud_builder->getFieldShowInColumn() as $input): ?><th> {php_open_tag_echo} cclang('<?= $input ?>') {php_close_tag}</th>
